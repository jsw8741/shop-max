...
public class ItemService {
	...
	// 
	public Page<MainItemDto> mainItemPage(ItemSearchDto itemSearchDto, Pageable pageable) {
		Page<MainItemDto> mainItmeDto = itemRepository.getMainItemPage(itemSearchDto, pageable);
		return mainItmeDto;
	}
